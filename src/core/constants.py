...
S2A_MODAL_TEXT_ROI: tuple[int, int, int, int] = (614, 93, 447, 23)
...
S1_BTN_SYNTHESIZE_ROI: tuple[int, int, int, int] = (920, 543, 154, 60)
S1A_BTN_OK_ROI: tuple[int, int, int, int] = (754, 558, 70, 34)
S1A_BTN_CANCEL_ROI: tuple[int, int, int, int] = (421, 558, 150, 34)
S2A_BTN_OK_ROI: tuple[int, int, int, int] = (754, 622, 70, 34)
...
WEAPON_SPECIAL_IDS: frozenset[str] = frozenset({"W1001", "W1002", "W1003", "W1004", "W1005"})
