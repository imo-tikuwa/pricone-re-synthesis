...
> [!IMPORTANT]
> **本リポジトリは 2026 年 7 月 19 日をもってアーカイブされました（開発・メンテナンス終了）。**
> ゲーム本体に「カスタム錬成」機能が実装され、本プロジェクトのツールが担っていた役割が
> ゲーム内でカバーされるようになったため、開発を終了しました。
> 既存のリリース・公開ページ・ソースコードは記録として残しますが、今後の更新・不具合対応・
> Issue / PR の受付は行いません。
